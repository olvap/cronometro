...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('new-competitor', '<input id="clock" name="clock" placeholder="00:00:00"> <p id="lap"></p> <button onclick="{start}">start</button> <button onclick="{stop}">stop</button> <button onclick="{lap}">lap</button> <button onclick="{reset}">reset</button>', '', '', function(opts) {
	    var attributes
	    attributes = this

	    var Tock = __webpack_require__(5)
	    var timer = new Tock({
	      callback: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	(function (root, factory) {
	  ...
	  var Tock = function Tock(options) {
	    options = options || {};
